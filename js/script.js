...
function openPage(evt, pageName, id) {
...
var head_links = document.querySelectorAll(".head__catalog-item");

var pages = {
  'catalog_pc': 'PC',
  'catalog_server': 'servers',
  'catalog_port': 'portable',
  'catalog_org': 'periph',
  'catalog_mat': 'consumables',
  'catalog_komp': 'accessories',
  'catalog_info': 'media'
};

head_links.forEach(function(link) {
